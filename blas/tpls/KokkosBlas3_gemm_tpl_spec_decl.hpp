...
#define KOKKOSBLAS3_GEMM_ONEMKL(SCALAR, LAYOUT, MEM_SPACE, ETI_SPEC_AVAIL)                                            \
  template <class ExecSpace>                                                                                          \
  struct GEMM<ExecSpace,                                                                                              \
    ...
    static void gemm(const ExecSpace& exec, const char transA[], const char transB[],                                 \
                     typename AViewType::const_value_type& alpha, const AViewType& A, const BViewType& B,             \
                     typename CViewType::const_value_type& beta, const CViewType& C) {                                \
      std::string label = "KokkosBlas::gemm[TPL_ONEMKL," + KokkosKernels::ArithTraits<SCALAR>::name() + "]";          \
      ...
      const std::int64_t K  = A.extent(A_t ? 0 : 1);                                                                  \
                                                                                                                       \
      oneapi::mkl::transpose trans_a = mode_kk_to_onemkl(transA[0]);                                                   \
      oneapi::mkl::transpose trans_b = mode_kk_to_onemkl(transB[0]);                                                   \
                                                                                                                       \
      ...
      if (row_major) {                                                                                                \
        oneapi::mkl::blas::row_major::gemm(exec.sycl_queue(), trans_a, trans_b, M, N, K, alpha, a, LDA, b, LDB, beta,  \
                                           c, LDC);                                                                    \
      } else {                                                                                                        \
        oneapi::mkl::blas::column_major::gemm(exec.sycl_queue(), trans_a, trans_b, M, N, K, alpha, a, LDA, b, LDB,     \
                                              beta, c, LDC);                                                           \
      }                                                                                                               \
      Kokkos::Profiling::popRegion();                                                                                  \
    }                                                                                                                  \
...
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutRight, Kokkos::SYCLDeviceUSMSpace, false)

KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(double, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(float, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace, false)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, true)
KOKKOSBLAS3_GEMM_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutRight, Kokkos::SYCLSharedUSMSpace, false)
