...
#define KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(SCALAR, LAYOUT, MEMSPACE)                \
  template <class ExecSpace>                                                            \
  struct symm_tpl_spec_avail<                                                           \
      ExecSpace,                                                                        \
...
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(double, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace)
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(float, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace)
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace)
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutLeft, Kokkos::SYCLDeviceUSMSpace)

KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(double, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace)
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(float, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace)
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(Kokkos::complex<double>, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace)
KOKKOSBLAS3_SYMM_TPL_SPEC_AVAIL_ONEMKL(Kokkos::complex<float>, Kokkos::LayoutLeft, Kokkos::SYCLSharedUSMSpace)
